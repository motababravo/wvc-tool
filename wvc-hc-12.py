...
if receiedData:
    ...
    if len(output) == 38 and output[0:6] == param[0:6] and output[-8:] == param[-8:]:
...
#        print("amperACHEXByte: " + amperACHEXByte + ", DEC: " + amperAC)
        ...
        publish.single(varMQtopic + "/aac", Lookup("lookup_WVC600", "AACB" + amperAC), hostname=varMQttBrk)
...
#        print("voltDCHEXByte: " + voltDCHEXByte + ", DEC: " + voltDC)
        ...
        publish.single(varMQtopic + "/vdc", Lookup("lookup_WVC600", "VDC" + voltDC), hostname=varMQttBrk)
...
#        print("amperDCHEXByte: " + amperDCHEXByte + ", DEC: " + amperDC)
        ...
        publish.single(varMQtopic + "/adc", Lookup("lookup_WVC600", "ADC" + amperDC), hostname=varMQttBrk)
